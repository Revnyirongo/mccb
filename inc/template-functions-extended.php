<?php
/**
 * Extended template functions for Malawi Bishops theme
 *
...
function malawi_bishops_hero_slider() {
    ...
    <div class="hero-slider">
        ...
        while ($hero_query->have_posts()) :
            ...
            $slide_text = has_excerpt() ? get_the_excerpt() : wp_trim_words(get_the_content(), 25, '...');
            
            // Slide style with background image
            $slide_style = $bg_image ? 'style="background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(' . esc_url($bg_image) . ') center/cover no-repeat;"' : '';
